...
public class BFTConnection implements Connection {
	...
	public void close() throws SQLException {
		Message close = new Message(OpcodeList.CLOSE,null,false);
	...
	public void rollback() throws SQLException {
		Message rollback = new Message(OpcodeList.ROLLBACK_SEND, null, false); //readonly?
	...
	public void commit() throws SQLException {
		...
		Message commit = new Message(OpcodeList.COMMIT, hashTable, false); //readonly?
	...
	public void setAutoCommit(boolean flag) throws SQLException {
		if(flag != autoCommit) {
			Message autoCommitMessage = new Message(OpcodeList.COMMIT_AUTO, flag, false); //readonly?
	...
	public DatabaseMetaData getMetaData() throws SQLException {
		...
		Message metadataMessage = new Message(OpcodeList.GET_DB_METADATA, clientId, false); //readonly?
	...
	throws SQLException {
		return new BFTPreparedStatement(this, mHandler, arg0, arg1);
	}
