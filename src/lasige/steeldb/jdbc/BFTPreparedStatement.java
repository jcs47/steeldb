...
public class BFTPreparedStatement implements PreparedStatement{
	...
	private Object process(String sql, int opcode, int opcodeOK) throws SQLException {
		if (closed) {
		...
		if(reply.getOpcode() == OpcodeList.EXECUTE_QUERY_ERROR)
			...
			throw new SQLException("Transaction aborted");
                else if(reply.getOpcode() != opcodeOK) {
                    throw new SQLException("Unexpected opcode during execution: " + reply.getOpcode());
                }
	...
	public ResultSet executeQuery() throws SQLException {
		...
		Object o = process(sql, OpcodeList.EXECUTE_QUERY, OpcodeList.EXECUTE_QUERY_OK);
	...
	public int executeUpdate() throws SQLException {
		...
		int result = (Integer)process(sql, OpcodeList.EXECUTE_UPDATE, OpcodeList.EXECUTE_UPDATE_OK);
...
//		throw new UnsupportedOperationException();
	...
	@Override
       public boolean execute() throws SQLException {
		...
		Object result = (Object)process(sql, OpcodeList.EXECUTE, OpcodeList.EXECUTE_OK);
